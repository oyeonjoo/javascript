...
promise.then(console.log, null) // resolve 등록, reject는 관심없음

promise.then(console.log)
promise.catch(console.log) // resolve는 관심없고, reject되면 log fn작동
...
new Promise((resolve, reject) =>
    ...
    .finally(() => console.log('promise가 생성되었습니다.')) // 성공하거나 실패하거나 상관없이 하고 싶은 것 등록